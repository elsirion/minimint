...
impl LightningModule {
    ...
    pub fn get_offers(&self, dbtx: &mut DatabaseTransaction) -> Vec<IncomingContractOffer> {
    ...
    pub fn list_gateways(&self, dbtx: &mut DatabaseTransaction) -> Vec<LightningGateway> {

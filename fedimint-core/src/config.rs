...
impl ClientConfig {
    ...
    pub fn consensus_hash(&self) -> anyhow::Result<sha256::Hash> {
...
// #[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, Encodable)]
// pub struct ModuleConfigConsensus {
//     pub kind: ModuleKind,
//     pub version: ModuleConsensusVersion,
//     pub config: Vec<u8>,
// }

// TODO: just use the same type? Or do we eg. want an json-encoded version here,
// or something?
type ModuleConfigConsensus = ClientModuleConfig;
...
pub struct ServerModuleConfig {
    ...
    pub consensus: ModuleConfigConsensus,
...
impl ServerModuleConfig {
    pub fn from(
        ...
        consensus: ModuleConfigConsensus,
